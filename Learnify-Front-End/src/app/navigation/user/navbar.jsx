...
export default function Navbar() {
  ...
  const visibleNavItems = USER_NAV_ITEMS.filter(
    ...
    <nav className="bg-white shadow-md sticky top-0 z-50 w-full">
      <div className="max-w-12xl mx-auto px-4 sm:px-6 lg:px-8 ml-20 mr-20">
        <div className="flex justify-between items-center h-16">
          ...
          {/* RIGHT — Desktop Dashboard + Avatar OR Login/Register */}
          <div className="hidden lg:flex items-center gap-6">
            {isAuthenticated ? (
              ...
              <>
                ...
                <Link
                  to="/register"
                  className="bg-zinc-900 text-white px-4 py-2 rounded-lg hover:bg-zinc-800 font-medium transition"
                >
                  Register
                </Link>
              </>
                  ...
                  {isAuthenticated ? (
                    ...
                    <div className="space-y-2">
                      ...
                      <Link
                        to="/register"
                        onClick={handleNavClick}
                        className="block w-full text-center bg-zinc-900 text-white px-4 py-2 rounded-lg hover:bg-zinc-800 font-medium transition"
                      >
                        Register
                      </Link>
                    </div>
        ...
        {/* Mobile Profile Dropdown - only show if authenticated */}
        {isAuthenticated && (
          <AnimatePresence>
            {dropdownOpen && (
              <motion.div
