...
const AdminProgressPage = React.lazy(
  () => import("@/features/admin/pages/ProgressPage"),
);
const AdminProgressDetailPage = React.lazy(
  () => import("@/features/admin/pages/ProgressDetailPage"),
);
const AdminSertifikatPage = React.lazy(
  () => import("@/features/admin/pages/SertifikatPage"),
);
...
const AdminProgressWrapper = (props) => (
  <React.Suspense fallback={<Loading />}>
    <AdminProgressPage {...props} />
  </React.Suspense>
);
const AdminProgressDetailWrapper = (props) => (
  <React.Suspense fallback={<Loading />}>
    <AdminProgressDetailPage {...props} />
  </React.Suspense>
);
const AdminSertifikatWrapper = (props) => (
  <React.Suspense fallback={<Loading />}>
    <AdminSertifikatPage {...props} />
  </React.Suspense>
);
