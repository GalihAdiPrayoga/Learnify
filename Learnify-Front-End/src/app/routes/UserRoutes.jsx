...
const CourseDetailPage = React.lazy(
  () => import("@/features/users/pages/CourseDetailPage"),
);
const CertificatePage = React.lazy(
  () => import("@/features/users/pages/CertificatePage"),
);
const CertificateDetailPage = React.lazy(
  () => import("@/features/users/pages/CertificateDetailPage"),
);
...
const CertificateDetailWrapper = (props) => (
  <React.Suspense fallback={<Loading />}>
    <CertificateDetailPage {...props} />
  </React.Suspense>
);
